<template>
  ...
  >
    <div class="flex justify-between text-xl mb-10 max-w-lg mx-auto">
      <img src="./assets/images/todoLogoSvg.svg" alt="Logo" />
      <button  @click="toggleDark()">
        <img src="./assets/images/icon-moon.svg" alt="Dark Mode" v-if="!isDark"/>
        <img src="./assets/images/icon-sun.svg" alt="Light Mode" v-else />
      </button>
    </div>
